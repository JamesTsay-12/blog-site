...
- 👉 [Critical review: Beware of Monte Carlo](https://www.jdsolomonsolutions.com/post/beware-of-monte-carlo-analysis-for-new-project-development)
...
1. The problem isn’t just that the stocks went down; it's the foundational flaws in how they were valued—based on fragile models that underestimated real-world friction.
2. For a fund claiming a long-term view, ARK has historically shown high portfolio turnover, often appearing to chase momentum rather than holding with conviction through volatility.
...
In contrast to ARK's top-down narrative style, many successful long-term investors exhibit the opposite traits. Think of managers who are former engineers or operators, with decades of experience in the industries they now analyze. Their method is less about forecasting a multi-trillion dollar market and more about a bottom-up analysis of a specific company’s technology, its unit economics, and its management team’s ability to execute.
